...
import random
    ...
    # lista_0_10 = [......]
def generar_lista():
    lista_generada = [x for x in range(11)]
    ...
    # tabla_5 = [......]
def generar_lista_x5():
    lista_generada_x5 = [x*5 for x in range(11)]
    print (lista_generada_x5)
    # 3)
    # Generar una lista a partir de comprensión de listas,
    ...
    # dias_mes = [.....]
def generar_lista_mes():
    lista_mes = [random.randint(1, 30) for x in range(30)]
    print (lista_mes)
